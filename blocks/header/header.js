...
function buildHeaderBar() {
  ...
  logoImg.src = '/content/dam/myhdfc/hdfc-logo.svg';
  ...
  badgeImg.src = '/content/dam/myhdfc/100hdfc.png';
...
export default async function decorate(block) {
  ...
  /* FIX 2: CLEAN STRING (NO IRREGULAR WHITESPACE) */
  hamburger.innerHTML = `
